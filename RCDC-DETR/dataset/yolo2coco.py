...
classes = ['iron sheet', 'rock bolt', 'coal gangue', 'angle iron', 'bolt', 'nut']
# classes = ['pedestrian', 'person', 'car', 'van', 'bus', 'truck', 'motor', 'bicycle', 'awning-tricycle', 'tricycle']

parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default='./mydata/images/val',type=str, help="path of images")
parser.add_argument('--label_path', default='./mydata/labels/val',type=str, help="path of labels .txt")
