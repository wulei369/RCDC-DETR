...
def get_params():
    params = {
        'weight': 'runs/train/rtdetr-r18/weights/best.pt', # 只需要指定权重即可
        'device': 'cuda:0',
        'layer': '9', # string 选取主干网络的最后一层
        'dataset': './dataset/mydata/images/train',
        'num_images': 50,
        'save_path': './Receptive field/result.png'
    }
    return params
